  ...
  try {
    ...
    if (isWarningPage) {
      ...
      try {
        ...
        const buttonSelector = 'button[id="continue-to-site"], button:contains("Continue to site"), .proceed-button, #proceed-button';
      ...
      if (await page.evaluate(() => document.body.innerText.includes("doesn't support a secure connection"))) {
        try {
          await page.evaluate(() => {
    ...
    // Continue with your code for file upload and clicking
    // Add your implementation for handling the imageUrl and other actions here
